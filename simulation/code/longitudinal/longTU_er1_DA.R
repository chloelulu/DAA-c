prefix <- 'er1'
resdir <-  file.path(paste0("/research/bsi/projects/staff_analysis/m216453/correlated/longTU/", prefix))
...
paras$resdir <- resdir
paras$prefix <- prefix
paras$methods <- c('lme','glmernb','GLMMPQL','ZIBR','LDM','NBMM','ZIGMM','ZINBMM','glmmadaptive','glmmTMB','LinDA','MaAsLin2CSS','MaAsLin2TMM','MaAsLin2GMPR')
