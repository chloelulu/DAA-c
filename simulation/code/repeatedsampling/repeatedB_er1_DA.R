prefix <- 'er1'
resdir <-  file.path(paste0("/research/bsi/projects/staff_analysis/m216453/correlated/repeatedB/", prefix))
...
paras$prefix <- prefix
paras$methods <- 'IFAA'
#paras$methods <-#c('lme','glmernb','GLMMPQL','ZIBR','LDM','NBMM','ZIGMM','ZINBMM','glmmadaptive','glmmTMB','LinDA','MaAsLin2')
...
setwd(resdir)
res <- clsapply(11:100, func, paras, queque='1-day', tempdir=file.path(resdir, 'tmpC'))
setwd(resdir)
