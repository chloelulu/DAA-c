clsapply <- function(dat, func, df=NULL, tempdir="~/project/tempZ",
  ...
  txt <- paste('
               ...
               '\n date()
                        ...
                        source("/research/bsi/projects/staff_analysis/m216453/correlated/code/ancom2.R")
                        source("/research/bsi/projects/staff_analysis/m216453/correlated/code/wrappers.R")

                        pkg <- c("nlme","lme4","LinDA","ZIBR","miLineage","LDM","aod","compositions","tidyverse","GMPR","glmmTMB","NBZIMM","GLMMadaptive","metamicrobiomeR","tibble")
