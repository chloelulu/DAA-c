...
load('Data/dat.IBD2017.subset100.meta.Rdata')
...
save(wrapper.obj, file = paste0('/research/bsi/projects/staff_analysis/m216453/correlated/Data/realsubset/', method,'_',i, '_IBD2017.res.Rdata'))
